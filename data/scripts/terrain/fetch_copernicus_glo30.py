"""
Download Copernicus DEM GLO-30 tiles covering the Dolomites bbox from the
public AWS Open Data bucket (no credentials, HTTPS).

Interpreter: E:/Projects/Dolomites/.venv/Scripts/python.exe.

Coverage
--------
Tiles N45..N47 x E010..E012 (nine 1 deg x 1 deg tiles at 1 arc-second /
~30 m). All nine exist on the bucket (probed 2026-09-06). Together they cover
the whole terrain bbox 10.3-12.7 E / 45.8-47.2 N with a border of unused
degree-tiles.

Vertical datum
--------------
Copernicus DEM heights are referenced to EGM2008 (EPSG:3855), i.e. orthometric
(Copernicus DEM Product Handbook v5.0, 2022-11-29, sec. 1.2). TINITALY 1.1 states
no datum, but its median difference to GLO-30 inside the bbox is about -3 m, so
it is orthometric too and the build applies no geoid correction. Details and
numbers: data/manifests/copernicus-dem-glo30.yaml.

Output
------
data/raw/copernicus-dem-glo30/Copernicus_DSM_COG_10_<lat>_00_<lon>_00_DEM.tif
data/raw/copernicus-dem-glo30/checksums.json  (sha256 + bytes per tile)
data/raw/copernicus-dem-glo30/fetch.log
...
RAW_DIR = Path(r"E:/Projects/Dolomites/data/raw/copernicus-dem-glo30")
BASE_URL = "https://copernicus-dem-30m.s3.amazonaws.com"

# All nine 1 deg tiles covering the Dolomites bbox (10.3-12.7 E, 45.8-47.2 N).
TILES: list[tuple[str, str]] = [
    (lat, lon)
    for lat in ("N45", "N46", "N47")
    for lon in ("E010", "E011", "E012")
]
